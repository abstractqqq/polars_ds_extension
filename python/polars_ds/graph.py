...
class GraphExt:
    ...
    here implicitly assumes the nodes are indexed by row number starting from 0. E.g. row #5, say the value of the
    ...
    be type u64. Values will be casted to u64 is possible.
